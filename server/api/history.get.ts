import mysql from "mysql2/promise"; //เรียกใช้ mysql
import { getConn } from '../utils/db' //เรียกใช้ฟังก์ชันเชื่อมต่อฐานข้อมูล
import jwt from "jsonwebtoken"; //เรียกใช้ jsonwebtoken สำหรับการตรวจสอบโทเค็น
